...
const features = [
  {
    icon: '☢️',
    title: 'Post-Apocalyptic Setting',
    body: 'Nuclear war has ended civilization. A bunker with limited spots is your only hope. Who gets in?',
  },
  {
    icon: '🎭',
    title: 'Hidden Roles',
    body: 'Each player receives a secret card — profession, health, skill, baggage. Reveal only what you choose.',
  },
  {
    icon: '🗳️',
    title: 'Vote & Debate',
    body: 'Convince others you deserve survival. Vote out those you deem unworthy. Every round counts.',
  },
  {
    icon: '⚡',
    title: 'Special Actions',
    body: 'Use unique abilities to peek at others\' cards, swap roles, or block votes at critical moments.',
  },
  {
    icon: '🌍',
    title: '60+ Unique Events',
    body: 'Random catastrophe events change the rules mid-game. Adapt or perish.',
  },
  {
    icon: '👥',
    title: '4–12 Players',
    body: 'Perfect for parties, game nights, team builds. No extra hardware needed — just phones.',
  },
]
    ...
    <div>
      ...
      >
        ...
        <ScrollReveal delay={2}>
          ...
          >
            Nuclear war wiped out civilization. A bunker can save only a few.
            Debate, bluff, and vote — decide who deserves to survive.
          </p>
        </ScrollReveal>
        ...
        <ScrollReveal>
          ...
          >
            ...
            <p style={{ fontFamily: 'Roboto Mono, monospace', fontSize: '0.88rem', color: 'var(--text-muted)', marginBottom: '2rem', lineHeight: 1.8 }}>
              Download Bunker for free and find out who among your friends<br />truly deserves a place in the shelter.
            </p>
            <a
              href="#"
              style={{
